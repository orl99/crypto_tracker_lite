...
void main() {
  ...
  final dummyChart = MarketChart(prices: [[123456789.0, 50000.0]]);
  final dummyDetail = CoinDetail(description: 'Bitcoin is a decentralized digital currency');
  ...
  group('CryptoDetailBloc Tests', () {
    ...
    blocTest<CryptoDetailBloc, CryptoDetailState>(
      ...
      build: () {
        when(() => mockCryptoService.getMarketChart(any()))
            .thenAnswer((_) async => dummyChart);
        when(() => mockCryptoService.getCoinDetail(any()))
